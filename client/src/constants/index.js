...
export const heroTag = 'Building products & brands';
export const gridSubIntro = 'With more than 4 years of experience in the tech industry, I have honed my skills in web development, and I am passionate about creating innovative solutions that meet the unique needs of each project. I am dedicated to delivering high-quality work that exceeds client expectations.';
...
export const labelsData = [{ lat: 40, lng: -100, color: "white", size: 10, text: "I'm here" }];
export const remoteWork = 'I work remotely from Lagos, Nigeria. I am available for remote work opportunities, and I am always looking to collaborate with other developers and designers. If you have a project you would like to discuss or if you would like to learn more about my work, please feel free to reach out to me. I would love to hear from you!';
export const bioText = 'I am a Full Stack Developer passionate about building innovative web solutions. Skilled in React, Node.js, and MongoDB, I create dynamic, responsive websites and applications. Committed to delivering high-quality work and always looking for new opportunities to expand my skillset.';
export const contactMe = 'Some long paragraph urging them to reach out.';
